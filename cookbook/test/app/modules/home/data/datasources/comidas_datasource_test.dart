...
void main() {
  group(
    "ComidasDatasoruce datasource",
    () {
      late MockDio dio;
      late IComidasDatasource comidasDatasoruce;
      String url =
          "https://www.themealdb.com/api/json/v1/1/filter.php?c=Seafood";

      setUp(() {
        dio = MockDio();
        comidasDatasoruce = ComidasDatasource(dio: dio);
      });
      ...
      test(
        ...
        () async {
          ...
          final result = await comidasDatasoruce.get("Seafood");
          verify(() => dio.get(url));
          expect(result, data);
        },
      );
