...
void main() {
  group(
    "ReceitasDatasoruce datasource",
    () {
      late MockDio dio;
      late IReceitasDatasource receitasDatasource;
      String url = "https://www.themealdb.com/api/json/v1/1/lookup.php?i=52772";

      setUp(() {
        dio = MockDio();
        receitasDatasource = ReceitasDatasource(dio: dio);
      });
      ...
      test(
        ...
        () async {
          ...
          final result = await receitasDatasource.get("52772");
          verify(() => dio.get(url));
          expect(result, data);
        },
      );
