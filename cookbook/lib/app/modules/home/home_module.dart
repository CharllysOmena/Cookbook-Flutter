...
import 'package:cookbook/app/modules/home/ui/pages/receita_favorita_page.dart';
...
class HomeModule extends Module {
  ...
  final List<Bind> binds = [
    Bind.lazySingleton((i) => ReceitaFavoritaStore(
        receitasRepository: i.get(), firebaseReceitaFavoritaService: i.get())),
    ...
    Bind.lazySingleton((i) => FirebaseReceitaFavoritaService()),
    ...
    Bind.lazySingleton(
        (i) => FavoritosStore(firebaseReceitaFavoritaService: i.get())),
  ...
  final List<ModularRoute> routes = [
    ...
    ChildRoute("/receita_favorita",
        child: (_, args) => const ReceitaFavoritaPage()),
  ];
}
